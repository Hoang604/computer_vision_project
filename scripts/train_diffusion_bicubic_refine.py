...
def train_diffusion(args):
    ...
    train_dataset = ImageDataset(
        folder_path=args.preprocessed_data_folder,
        img_size=args.img_size,
        downscale_factor=args.downscale_factor,
        use_preprocessed=True  # This will auto-detect and use bicubic preprocessed data
    )
    ...
    if args.val_preprocessed_data_folder:
        ...
        val_dataset = ImageDataset(
            folder_path=args.val_preprocessed_data_folder,
            img_size=args.img_size,
            downscale_factor=args.downscale_factor,
    ...
    scheduler = create_scheduler(
        ...
        lr_decay_factor=args.lr_gamma,
        cosine_t_max=args.cosine_t_max_epochs,
...
if __name__ == "__main__":
    ...
    # Additional scheduler args not in common args
    ...
    print_config(args, "Diffusion Model Training Configuration (On-the-fly Feature Extraction)")
